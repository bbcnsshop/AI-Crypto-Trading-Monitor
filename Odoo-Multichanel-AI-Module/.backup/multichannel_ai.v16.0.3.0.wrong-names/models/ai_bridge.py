...
class AIAvailabilityMixin(models.AbstractModel):
    ...
    _name = 'multichannel.ai.availability.mixin'
    ...
    def is_ai_available(self):
        ...
        """
        try:
            # Try to access multichannel.ai.engine model
    ...
    def get_ai_engine(self):
        ...
        Returns:
            multichannel.ai.engine recordset or None
        """
        try:
            return self.env['multichannel.ai.engine'].get_default_engine()
        except Exception as e:
...
class AIAwareMixin(models.AbstractModel):
    ...
    """
    _name = 'multichannel.ai.aware.mixin'
    ...
    def get_pricing_engine(self):
        ...
        Returns:
            object: Either multichannel.ai.engine or FormulaPricingMixin
        """
        # Try AI engine first
        try:
            return self.env['multichannel.ai.engine'].get_default_engine()
