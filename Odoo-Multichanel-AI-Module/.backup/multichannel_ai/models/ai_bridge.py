...
class AIAvailabilityMixin(models.AbstractModel):
    ...
    def is_ai_available(self):
        """Check if ai_engine module is installed and accessible.
        
        Returns:
            bool: True if ai_engine is available, False otherwise
        """
        try:
            # Try to access ai.engine model - this will raise if not installed
    ...
    def get_ai_engine(self):
        """Get ai_engine record if available, None otherwise.
